...
##################################################
# SEGNET
CUDA_VISIBLE_DEVICES=1 python3 main.py --operation training --output_path /home/kno/remote_sensing_segmentation/output_river/segnet/256/ \
--dataset river --dataset_input_path /home/kno/bacia/Bacia_SantoAntonio_Revisado/ --num_classes 2 --model_name segnet --batch_size 16 \
--reference_crop_size 256 --reference_stride_crop 256 --values 256 --distribution_type single_fixed
